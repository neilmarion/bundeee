...
public class SimpleNumberInputViewV2
    ...
    // with a dialog
    public SimpleNumberInputViewV2
        (Activity activity,
        ...
        LinearLayout layout =
            (LinearLayout) inflater.inflate(R.layout.simple_number_input_v2, null);
    ...
    private View.OnClickListener getKeypadEnterButtonOnClickListener() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                soundBoard.playEnterSoundEffect();
    ...
    private View.OnClickListener getKeypadOnClickListener() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //soundBoard.playKeypadSoundEffect();
